...
// Both platforms use direct detached spawn with an fd redirect — this
...
// Liveness is deliberately NOT checked here: the supervisor re-verifies the
// spawned pid (with the PID-reuse guard) before declaring success.
async function spawnDetachedNodeWindows({ scriptPath, args, logOut, cwd }) {
